# Running LLM Workloads on Kubernetes - GITEX Dubai 2025

Welcome to the **"Running LLM Workloads on Kubernetes"** workshop at GITEX Dubai 2025! 

## What We'll Learn Today

In this 40-minute hands-on workshop, you'll discover how to:

- 🚀 Deploy Large Language Models (LLMs) on Kubernetes
- 🔧 Use vLLM for high-performance CPU inference
- 🏗️ Build a Retrieval-Augmented Generation (RAG) application
- 🏢 Implement multi-tenancy with vcluster
- ⚡ Scale and optimize LLM workloads
...
### 🎯 **Resource Management**
- **GPU Scheduling** - Efficiently allocate GPU resources for model inference
...
- **Multi-tenancy** - Isolate different teams and workloads
